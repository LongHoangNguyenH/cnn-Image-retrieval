...
def main():
    ...
    for dataset in datasets: 
        ...
        print('Saving........................')
        np.save('output/vector_ResParis.npy',vecs)
        np.save('output/query_vectors_ResParis_.npy', qvecs)
        np.save('output/scores_ResParis.npy', scores)
        np.save('output/ranks_ResParis.npy', ranks)
